...
<form action="<?php echo URLROOT; ?>/UserController/update/<?php echo $data->id ?>" method="post" style="width: 526px; margin: auto; margin-top: 50px; font-family:Tahoma;">
  ...
  <div class="form-group">
    ...
    <input type="text" name="auteur" value="<?php echo $data->Auteur ;?>" class="form-control" ><br>
  </div>

  <div class="form-group">
   
    <label for="content">Date</label>
    <textarea name="date" placeholder="" id="content" cols="70" rows="11" style="padding: 10px;"><?php echo $data->date ;?> </textarea>
  </div>
  <label for="content">catégorie</label>
    <textarea name="categorie" placeholder="" id="content" cols="70" rows="11" style="padding: 10px;"><?php echo $data->categorie ;?> </textarea>
  </div>
  <label for="content">résumé</label>
    <textarea name="résumé" placeholder="" id="content" cols="70" rows="11" style="padding: 10px;"><?php echo $data->resume;?> </textarea>
  </div>
